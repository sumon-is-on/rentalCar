...
<div class="flex">
    <div class="flex ">
        <form action="{{ route('donor.index') }}" method="GET" role="search">
            <div class="flex input-group">
                <span class="input-group-btn mr-5"></span>
                <input type="text" value="{{ $search }}" class=" border rounded w-96 py-1 px-2 text-gray-700" name="search" placeholder="Search a donor" id="search">
                <a href="{{ route('donor.index') }}" class="ml-2">
        ...
        <div style="margin:20px;">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <td class="py-1 px-6">
                        <div class="flex">
                            <a href="{{ route('donor.show',$user->id) }}"class="text-indigo-600 hover:text-indigo-900">
